...
//        }
    ...
    public void printText(String data,String align) {
        byte[] line;

        if ("center".equals(align)){
            line = Printer.printfont(data + "\n\n", FontDefine.FONT_24PX, FontDefine.Align_CENTER, (byte) 0x1A, PocketPos.LANGUAGE_PORTUGUESE);
        }else if ("right".equals(align)){
            line = Printer.printfont(data + "\n\n", FontDefine.FONT_24PX, FontDefine.Align_RIGHT, (byte) 0x1A, PocketPos.LANGUAGE_PORTUGUESE);

        }else{
            line = Printer.printfont(data + "\n\n", FontDefine.FONT_24PX, FontDefine.Align_LEFT, (byte) 0x1A, PocketPos.LANGUAGE_PORTUGUESE);
        }
